...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'sortdata/sort_messages_','.xml');
	krpanoLoaded = true;
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"sortdata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"sortdata/graphics/KolorMenu/KolorMenu.min.js", [], true);
